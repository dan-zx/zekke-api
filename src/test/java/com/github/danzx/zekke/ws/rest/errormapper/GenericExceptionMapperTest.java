...
public class GenericExceptionMapperTest extends BaseMockitoTest {

    private @Mock HttpHeaders headers;

    private @InjectMocks GenericExceptionMapper mapper;
    ...
    public void shouldMapperRespondWithErrorMessage() {
        ...
        assertThat(entity)
            ...
            .containsOnly(500, ErrorMessage.Type.OTHER, "Unexpected error: Boom!!!", null);
    }
}
